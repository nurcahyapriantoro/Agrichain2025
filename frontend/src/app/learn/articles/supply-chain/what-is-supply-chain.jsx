  ...
  return (
    <article>
      ...
      <div className="prose prose-lg max-w-none">
        <h2>Introduction to Supply Chains</h2>
        
        <p>
          A supply chain encompasses the end-to-end system of producing and delivering a product or service, from the initial stage of 
          sourcing raw materials to the final delivery of the product or service to end users. Supply chains include all of the 
          functions, businesses, activities, and resources involved in the end-to-end process.
        </p>

        <p>
          According to Christopher (2016), "A supply chain is the network of organizations that are involved, through upstream and 
        ...
        <h2>Key Components of a Supply Chain</h2>
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-lg p-6 my-8">
          <h3 className="text-blue-800 text-xl mb-2">Critical Supply Chain Functions</h3>
          <p className="mb-4">
        ...
        <h2>Agricultural Supply Chains: Unique Characteristics</h2>
        ...
        <div className="my-8 bg-gray-50 p-8 rounded-lg border border-gray-200 shadow-sm">
          <h3 className="text-gray-800 text-xl mb-4">Agricultural Supply Chain: Farm to Table Process</h3>
          <ol className="list-decimal pl-6 space-y-2 text-gray-700">
            <li><strong>Production</strong>: Growing and harvesting of crops or raising animals</li>
            <li><strong>Collection</strong>: Gathering harvested products from multiple farms</li>
            <li><strong>Processing</strong>: Transforming raw agricultural products into marketable forms</li>
            <li><strong>Packaging</strong>: Preparing products for storage, transportation, and retail</li>
            <li><strong>Distribution</strong>: Moving products to various geographic markets</li>
            <li><strong>Wholesale</strong>: Selling products in bulk to retailers or other businesses</li>
            <li><strong>Retail</strong>: Making products available to end consumers</li>
            <li><strong>Consumption</strong>: Final use of agricultural products by consumers</li>
          </ol>
        </div>
        
        <h2>Supply Chain Management: Principles and Importance</h2>
        ...
        <h2>Modern Challenges in Supply Chain Management</h2>
        ...
        <h2>Technological Transformation in Supply Chains</h2>
